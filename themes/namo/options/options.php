					...
					if(true === $this->args['show_import_export']){
						echo '<div id="import_export_default_section_group'.'" class="nhp-opts-group-tab">';
							...
							echo '</div>';
								...
								echo '<input type="text" class="large-text" id="nhp-opts-export-link-value" value="'.esc_url( add_query_arg(array('feed' => 'nhpopts-'.$this->args['opt_name'], 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), site_url()) ).'" />';
